...
push new song,
grow Threads audience...

Anything HERE helps AI generate
better captions and content ideas."
                ...
                {contentProjects.map((project) => (
                    <article className="archive-card" key={project.id}>
                        <div className="project-header">
                            <strong>
                                {getProjectEmoji(project.name)} {project.name}
                            </strong>
                                        ...
                                        >
                                            ...
                                            <span>
                                                {platform.cadence === "daily"
                                                    ? `${platform.postsPerDay || 1}x/day`
                                                    : `${platform.frequency || 1}x/week`}
                                            </span>

                                            <span>
                                                {(platform.purposes || []).join(", ") || "General"}
                                            </span>
                                        </button>
                                    );
                                }
                                            ...
                                            <div className="slot-picker">
                                                {timeSlots.map((slot) => (
                                                    <label key={slot}>
                                                        <input
                                                            type="checkbox"
                                                            checked={(platform.timeSlots || []).includes(
                                                                slot
                                                            )}
                                                            onChange={() =>
                                        ...
                                        <div className="purpose-picker">
                                            {purposeOptions.map((purpose) => (
                                                <label key={purpose}>
                                                    <input
                                                        type="checkbox"
                                                        checked={(platform.purposes || []).includes(
                                                            purpose
                                                        )}
                                                        onChange={() =>
                                            ...
                                            {dayOptions.map((day) => (
                                                <label key={day}>
                                                    <input
                                                        ...
                                                        onChange={() =>
                                                            toggleDay(project.id, platform.id, day)
                                                        }
                                                    />
                                                    {day}
                                                </label>
